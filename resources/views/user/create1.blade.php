                        ...
                        <form action="{{ route('user.store') }}" method="post" class="repeater"
                            ...
                            <div class="row margin-wrap">
                                <div class="col-sm-2"><input type="hidden" name="parrent[0][1]" value="1" />
                                    ...
                                    <input type="number" class="form-control" required value="" name="id[0][1]"
                                           id="parent_id_0" placeholder="Enter ID">
                                </div>
                                <div class="col-sm-2">
                                    <label for="name" class="form-label">Name</label>
                                    <input type="text" class="form-control" required value="" name="name[0][1]"
                                           placeholder="Enter Name">
                                </div>
                                <div class="col-sm-2">
                                    <label for="age" class="form-label">Age</label>
                                    <input type="number" class="form-control" required name="age[0][1]"
                                           placeholder="Enter Age">
                                </div>
                                <div class="col-sm-2">
                                    <label for="veteran" class="form-label">Veteran</label>
                                    <input type="text" class="form-control" required name="veteran[0][1]"
    ...
    <script>
        ...
        function addChildsOnClick(parrent) {
            ...
            $html = '<div class="row margin-wrap" data-id="' + row + '"  >' +
                ...
                '<label for="Id" class="form-label">ID</label>' +
                '<input type="text" class="form-control" required name="id[' + parrent + '][' + row + ']" placeholder="Enter ID">' +
                '</div>' +
                '<div class="col-sm-2">' +
                '<label for="name" class="form-label">Name</label>' +
                '<input type="text" class="form-control" required name="name[' + parrent + '][' + row + ']" placeholder="Enter Name">' +
                '</div>' +
                '<div class="col-sm-2">' +
                '<label for="age" class="form-label">Age</label>' +
                '<input type="text" class="form-control" required name="age[' + parrent + '][' + row + ']" placeholder="Enter Age">' +
                '</div>' +
                '<div class="col-sm-2">' +
                '<label for="veteran" class="form-label">Veteran</label>' +
                '<input type="text" class="form-control" required name="veteran[' + parrent + '][' + row + ']" placeholder="Enter Yes/No">' +
                '</div>' +
                '<div class="col-sm-2 buttons">' +
                '<button type="submit" class="btn btn-default btn-primary">Save</button>' +
